...
# 
add_interface dram conduit end
set_interface_property dram associatedClock ""
set_interface_property dram associatedReset ""
...
add_interface_port dram DRAM_ADDR addr Input 13
add_interface_port dram DRAM_BA ba Input 2
add_interface_port dram DRAM_CAS_N cas_n Input 1
add_interface_port dram DRAM_CKE cke Input 1
add_interface_port dram DRAM_CLK clk Input 1
add_interface_port dram DRAM_CS_N cs_n Input 1
add_interface_port dram DRAM_DQ dq Bidir 16
add_interface_port dram DRAM_LDQM ldqm Output 1
add_interface_port dram DRAM_RAS_N ras_n Input 1
add_interface_port dram DRAM_UDQM udqm Input 1
add_interface_port dram DRAM_WE_N we_n Input 1
